  ...
  return (
    <div className='Contact' id='Contact'>
      ...
      <div className="reseauContainer">
          <a target= "_blank" rel="noreferrer" href='https://github.com/Alex041718'><img src={"https://upload.wikimedia.org/wikipedia/commons/9/91/Octicons-mark-github.svg"} alt="Github" /></a>
